...
public class EntityShopKeeper extends EntityScapecraft
{
	...
	public EntityShopKeeper(World par1World)
	{
		super(par1World);
	...
	{
		Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText("\u00a7EShopKeeper: Please look around the shop! Right click to buy an item"));
