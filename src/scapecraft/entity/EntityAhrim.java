...
public class EntityAhrim extends EntityScapecraft
{
	...
	public boolean attackEntityAsMob(Entity par1Entity)
	{
		if (super.attackEntityAsMob(par1Entity))
		{
			...
			{
				((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 200, 3));
				((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, 500, 3));
				((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(MobEffects.POISON, 200, 0));
			}
