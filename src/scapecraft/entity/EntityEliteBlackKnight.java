...
{
	private static final ItemStack defaultHeldItem = new ItemStack(ScapecraftItems.equipmentSets.get("blackHammer"), 1);

	public EntityEliteBlackKnight(World par1World)
	{
		super(par1World);
		this.setSize(this.width * 1.5F, this.height * 1.0F);
