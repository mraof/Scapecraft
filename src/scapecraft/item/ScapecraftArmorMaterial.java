...
public enum ScapecraftArmorMaterial
{
	...
	BRONZE(80, new int[]{3, 5, 3, 2}, 10, 0, 6D),
	MITH(190, new int[]{3, 5, 3, 2}, 10, 30, 20D),
	ADDY(250, new int[]{3, 5, 3, 2}, 10, 40, 24D),
	RUNE(290, new int[]{3, 5, 3, 2}, 10, 50, 30D),
