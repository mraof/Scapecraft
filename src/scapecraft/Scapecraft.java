...
/*		DimensionType dimensionType = DimensionType.register("Dungeon", "_dungeon", dungeonProviderId, WorldProviderDungeon.class, true);
		DimensionManager.registerDimension(dungeonDimensionId, dimensionType);*/
	...
	public void serverStarted(FMLServerStartedEvent event)
	{
		...
		for (Object entry : EntityList.stringToClassMapping.entrySet())
		{
			try
			{
				String name = ((Entity)((Class<?>) ((Map.Entry) entry).getValue()).getConstructor(World.class).newInstance(FMLCommonHandler.instance().getMinecraftServerInstance().getEntityWorld())).getName();
